<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Bookinventry.aspx.cs" Inherits="E_Library.Bookinventry" %>
                                          ...
                                          <div class="col-lg-10">
                                             ...
                                             <div class="row">
                                                <div class="col-12">
                                                   ...
                                                   &nbsp;| Publish Date -
                                                   <asp:Label ID="Label6" runat="server" Font-Bold="True" Text='<%# Eval("publishe_date") %>'></asp:Label>
                                                   &nbsp;| Pages -
