            ...
            <div class="card bg-dark text-white">
               <div class="card-body">
                  <div class="row">
                     <div class="col">
                        <center>
                           <img width="100px" src="Image/imgs/generaluser.png" />
                        </center>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col">
                        <center>
                           ...
                           <asp:Label class="badge badge-pill badge-sucess" ID="Label1" runat="server" Text="Your status"></asp:Label>
                        </center>
                     </div>
                  </div>
                  <div class="row">
            ...
            <div class="card ">
               <div class="card-body">
                  <div class="row">
                     <div class="col">
                        <center>
                          <img width="100px"  src="Image/imgs/books1.png" />
                        </center>
                     </div>
                  </div>
                  <div class="row">
